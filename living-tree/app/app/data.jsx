...
const GALLERY_ITEMS = [
  { id:'hero-04',  cat:'Hero Render', src:'assets/renders/render-04.png',     title:'LivingTree by night — aerial render', tag:'Hero render' },
  { id:'hero-05',  cat:'Hero Render', src:'assets/renders/render-05.png',     title:'Numbering plan with tree clusters',   tag:'Tower layout' },
  { id:'plan-mp',  cat:'Masterplan',  src:'assets/renders/masterplan-03.png', title:'Master plan with 65 amenities',        tag:'Masterplan' },
  { id:'land-cov', cat:'Landscape',   src:'assets/renders/cover-01.png',       title:'Flowing roots wreath — Designed for Life', tag:'Brand mark' },
  { id:'fp-1bhk',  cat:'Floor Plans', src:'assets/plans/plan-07.png',          title:'1 BHK East & West',                    tag:'1 BHK' },
  { id:'fp-2bhk',  cat:'Floor Plans', src:'assets/plans/plan-08.png',          title:'2 BHK East & West',                    tag:'2 BHK' },
  { id:'fp-25bhk', cat:'Floor Plans', src:'assets/plans/plan-09.png',          title:'2.5 BHK East & West',                  tag:'2.5 BHK' },
  { id:'fp-3sm',   cat:'Floor Plans', src:'assets/plans/plan-10.png',          title:'3 BHK Smart East & West',              tag:'3 BHK Smart' },
  { id:'fp-3op',   cat:'Floor Plans', src:'assets/plans/plan-11.png',          title:'3 BHK Optimal East & West',            tag:'3 BHK Optimal' },
  { id:'fp-3lx',   cat:'Floor Plans', src:'assets/plans/plan-12.png',          title:'3 BHK Luxe East & West',               tag:'3 BHK Luxe' },
  { id:'bro-bk',   cat:'Brochure',    src:'assets/renders/backcover-15.png',   title:'Brochure back cover',                  tag:'Brochure' },
];
